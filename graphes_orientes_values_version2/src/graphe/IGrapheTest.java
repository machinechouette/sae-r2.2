...
public  class IGrapheTest {
	...
	void tester3_1(IGraphe g) {
		...
		System.out.println("Sommets attendus : " + sommets_exp);
	    System.out.println("Sommets obtenus : " + sommets);
	    System.out.println("Contient sommet C : " + g.contientSommet("C"));
	    System.out.println("Contient arc C->H : " + g.contientArc("C", "H"));
	    System.out.println("Valuation E->H attendue : 7, obtenue : " + g.getValuation("E", "H"));
	    System.out.println("Successeurs de D attendus : " + List.of("B", "C", "E"));
	    System.out.println("Successeurs de D obtenus : " + successeurs);
	    System.out.println("Graphe attendu : " + g31);
	    System.out.println("Graphe obtenu : " + g.toString());
	}
	
	public void testImportation(IGraphe g) {
		Arc a = GraphImporter.importer("/Users/Maissane/eclipse-workspace/graphes_orientes_values_version2/src/graphe/g-10-1.txt", g);
		assertEquals("1-3(5), "
